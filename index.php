<?php
    ...
    //Ưu đãi trong ngày, cần sửa lại sau
    $sqlDealProduct = " SELECT
                            price-sale_price as sale,
                            products.*,
                            comments.rating
                        from products
                        LEFT JOIN comments
    ...
    $sqlQuery = "SELECT * from products order by rate asc limit 16";
