	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Quản trị WEBSITE</h3><br>
                                    <p>Chào mừng bạn đến với quản trị. <br>Mời bạn đăng nhập để tiếp tục.</p>
                                </div>
                            </div>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><img style="width: 20px" src="../images/icons/login.png" alt=""> Đăng nhập</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-top-tab" data-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false"><img style="width: 20px" src="../images/icons/unlock.png" alt=""> Đăng ký</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="" name="username" placeholder="Tên tài khoản" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            
                                            <input type="text" required="" name="password" placeholder="Mật khẩu" class="form-control">
                                        </div>
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                <input type="checkbox" name="remember" value="ok" class="custom-control-input" id="customControlAutosizing">
                                        ...
                                        <div class="form-button">
                                            ...
                                            <input type="submit" name="btn_login" class="btn btn-primary" value="Đăng nhập" onclick="return validateForm()">
                                        </div>
                                    ...
                                    <form class="form-horizontal auth-form">
                                        ...
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                ...
                                                <label class="custom-control-label" for="customControlAutosizing1"><span>Tôi đồng ý với  <a href="#"  class="pull-right">&#160; Điều khoản &amp; Điều kiện</a></span></label>
                                            </div>
                                        </div>
                                        <div class="form-button">
                                            <button name="btn_register" class="btn btn-primary" type="submit">Đăng ký</button>
                                        </div>
                                        <div class="form-footer">
...
<!-- Mirrored from themes.pixelstrap.com/bigdeal/admin/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2019 04:33:15 GMT -->
</html>